...
const NotFound: React.FC = () => (
  <div style={{ minHeight: '60vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', color: '#b71c1c', fontWeight: 700 }}>
    ...
    <a href="/" style={{ color: '#e0b04b', marginTop: 24, fontSize: '1.1rem', textDecoration: 'underline' }}>Go to Home</a>
  </div>
);
                          ...
                          {({ user, loading }) => (
                            loading ? (
                              ...
                              <Routes key={user?.role}>
                                ...
                                <Route path="/dashboard/branch/reports" element={user?.role === 'branchManager' ? <Reports /> : <Forbidden />} />
