...
const AdminMenuManagement: React.FC = () => {
  ...
  return (
    <Container>
      <h1 style={{color:'#e0b04b',marginBottom:24}}>Menu Management</h1>
      <Section>
        <h2 style={{color:'#e0b04b',fontSize:'1.1rem'}}>Current Menu</h2>
        <Table>
                ...
                <Td>
                  {editing===item.id ? (
                    ...
                    <>
                      ...
                      <Button onClick={()=>handleDelete(item.id)} style={{background:'#b71c1c',color:'#fff'}}>Delete</Button>
                    </>
                  )}
                </Td>
              </tr>
      ...
      <Section>
        <h2 style={{color:'#e0b04b',fontSize:'1.1rem'}}>Add New Menu Item</h2>
