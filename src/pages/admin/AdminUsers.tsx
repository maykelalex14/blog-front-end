...
const AdminPageAccess: React.FC = () => (
  <div style={{marginTop:32, marginBottom:32}}>
    <h2 style={{color:'#e0b04b', fontSize:'1.3rem', marginBottom:16}}>Role Page Access Overview</h2>
    <AccessTable>
      <thead>
        <tr>
          <Th>Role</Th>
  ...
  return (
    <AdminContainer>
      ...
      <div style={{marginBottom:32}}>
        <h2 style={{color:'#e0b04b',fontSize:'1.2rem',marginBottom:8}}>Registered Customers</h2>
          ...
          <ul style={{color:'#fff',fontSize:'1.05rem',margin:0,paddingLeft:20}}>
            {registeredUsers.map((u,i) => (
              <li key={i} style={{display:'flex',alignItems:'center',gap:12}}>
                {u.username}
                <Button type="button" style={{background:'#b71c1c',color:'#fff',padding:'4px 12px',fontSize:'0.95em'}} onClick={()=>deleteCustomer(u.username)}>Delete</Button>
              </li>
            ))}
          </ul>
        )}
      ...
      <AdminPageAccess />
      <form onSubmit={handleAddStaff} style={{display:'flex',gap:12,marginBottom:24,alignItems:'center'}}>
        <Input
          type="text"
        ...
        <tbody>
          {staff.map(u => (
            <tr key={u.id}>
              ...
              <Td>
                <Button type="button" style={{background:'#b71c1c',color:'#fff',padding:'4px 12px',fontSize:'0.95em'}} onClick={()=>deleteStaff(u.id)}>Delete</Button>
              </Td>
            </tr>
          ))}
        </tbody>
