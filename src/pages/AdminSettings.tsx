      ...
      <div className="bg-white rounded-lg shadow p-6">
        <div className="flex gap-2 mb-6 border-b-0">
          {tabList.map(t => (
            <button
              key={t.key}
              className={`py-2 px-4 font-semibold border-b-2 transition-colors duration-150 ${tab === t.key ? 'border-b-[#b71c1c] text-[#b71c1c]' : 'border-b-transparent text-gray-500'}`}
        ...
        {tab === 'users' && (
          <div>
            <div className="flex justify-between items-center mb-4">
              ...
              <button className="bg-[#e0b04b] text-white px-4 py-2 rounded font-semibold" onClick={() => setShowUserDialog(true)}>Add User</button>
            </div>
                ...
                <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-md">
                  ...
                  <form className="flex flex-col gap-3" onSubmit={e => { e.preventDefault(); setShowUserDialog(false); }}>
                    ...
                    <div className="flex gap-2 mt-2">
                      <button type="submit" className="bg-[#e0b04b] text-white px-4 py-2 rounded font-semibold">Save</button>
        ...
        {tab === 'site' && (
          <div>
            ...
            <form className="flex flex-col gap-4 max-w-md" onSubmit={e => e.preventDefault()}>
              ...
              <button type="submit" className="bg-[#e0b04b] text-white px-4 py-2 rounded font-semibold">Save Settings</button>
            </form>
          </div>
        )}
        ...
        {tab === 'security' && (
          <div>
            ...
            <div className="flex flex-col gap-4 max-w-md">
              <button className="bg-[#b71c1c] text-white px-4 py-2 rounded font-semibold">Reset All Passwords</button>
              <button className="bg-[#e0b04b] text-white px-4 py-2 rounded font-semibold">Enable 2FA</button>
            </div>
