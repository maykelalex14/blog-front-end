...
const ManagerFeedback: React.FC<ManagerFeedbackProps> = ({ allBranches }) => {
  ...
  if (allBranches) {
    return (
      <Card>
        <h2 style={{ color: '#222', marginBottom: 24 }}>Customer Feedback (All Branches)</h2>
              ...
              <Review key={i}>
                ...
                <div>
                  {r.responded ? (
                    ...
                    <span style={{ color: '#b71c1c', fontWeight: 600 }}>No response yet</span>
                  )}
                </div>
              </Review>
            ))}
  ...
  return (
    <Card>
      <h2 style={{ color: '#222', marginBottom: 24 }}>Customer Feedback</h2>
