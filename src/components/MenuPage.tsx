...
const MenuCard = styled.div`
  background: #fff;
  border-radius: 14px;
  box-shadow: 0 2px 12px rgba(124,45,18,0.08);
...
const AddBtn = styled.button`
  background: linear-gradient(90deg, #7c2d12 60%, #e85d04 100%);
  color: #fff8f0;
  border: none;
  border-radius: 8px;
  ...
  &:hover {
    background: linear-gradient(90deg, #e85d04 60%, #7c2d12 100%);
  }
`;
...
const CartIconBtn = styled.button`
  ...
  font-size: 2rem;
  box-shadow: 0 2px 8px rgba(80,30,30,0.10);
  cursor: pointer;
  transition: background 0.2s;
  &:hover {
    background: #ffd166;
